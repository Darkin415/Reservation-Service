...
namespace SeatReservation.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20250715085556_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeatReservation.Domain.Reservation.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SeatReservation.Domain.Reservation.ReservationSeat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SeatReservation.Domain.Venue.Seat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("seat_id");
            ...
            modelBuilder.Entity("SeatReservation.Domain.Venue.Venue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("venue_id");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("VenueName", "SeatReservation.Domain.Venue.Venue.VenueName#VenueName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("SeatReservation.Domain.Events.Event", b =>
                {
                    b.HasOne("SeatReservation.Domain.Venue.Venue", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SeatReservation.Domain.Reservation.ReservationSeat", b =>
                {
                    b.HasOne("SeatReservation.Domain.Venue.Seat", null)
                        .WithMany()
                        .HasForeignKey("SeatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SeatReservation.Domain.Reservation.Reservation", "Reservation")
                    ...
                    b.OwnsOne("SeatReservation.Domain.Details", "Details", b1 =>
                        {
                            ...
                            b1.OwnsMany("SeatReservation.Domain.SocialNetwork", "Social", b2 =>
                                {
